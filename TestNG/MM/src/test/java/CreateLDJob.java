...
@FindBy (className = "select2-results__option")
    List<WebElement> selectEstimator;
@FindBy (id="save-job")
...
@FindBy (className = "swal-button--confirm")
    ...
    WebDriver driver ;
    public CreateLDJob (WebDriver driver){
        this.driver = driver;
        PageFactory.initElements(driver,this);
    }

    public void _createLDJob() throws InterruptedException {
